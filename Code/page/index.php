...
<body id="page-top">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Direitos Autorais &copy; WatchZone 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="../js/demo/chart-area-demoe.js"></script>
    <script src="../js/demo/chart-pie-demo.js"></script>

    <script src="https://kit.fontawesome.com/f5a72921ad.js" crossorigin="anonymous"></script>
